...
public class CitaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (idRol == 2) {
            setContentView(R.layout.cita_veterinario_activity); //Si el rol es de veterinario mandar al xml de veterinario
            ...
            setContentView(R.layout.cita_usuario_activity); //Si el rol es de usuario mandar al xml de usuario
