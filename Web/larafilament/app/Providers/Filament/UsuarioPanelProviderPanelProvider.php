...
class UsuarioPanelProviderPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverWidgets(in: app_path('Filament/UsuarioPanelProvider/Widgets'), for: 'App\\Filament\\UsuarioPanelProvider\\Widgets')
            ->widgets([
